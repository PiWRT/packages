...
| `luci-app-wolultra` | `20260802-r1` | wol 功能的 LuCI 管理界面与 OpenWrt 集成。 | [PiWRT/packages](https://github.com/PiWRT/packages) |

## 核心与依赖来源

| 软件包 | 版本 | 源码来源 |
| --- | --- | --- |
| `axonhub` | `20260804-r1` | [VIKINGYFY/packages](https://github.com/VIKINGYFY/packages) |
